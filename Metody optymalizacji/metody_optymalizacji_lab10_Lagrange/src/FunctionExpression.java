public class FunctionExpression {
    ...
    public void zwrocWartoscFunkcji(){
        System.out.println("Zmienna: " + this.function.variable + "  expression " + this.function.expression+ " wartosc: " +this.function.value);
    }
    ...
    public static FunctionExpression sub(Function a, double b){
        FunctionExpression out=new FunctionExpression(new Function("-"));
        out.addLeft(new FunctionExpression(a));
        out.addRight(new FunctionExpression(new Function("const","/",b)));
        return out;
