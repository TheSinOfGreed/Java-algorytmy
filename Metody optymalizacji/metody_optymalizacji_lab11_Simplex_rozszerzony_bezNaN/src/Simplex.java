public class Simplex {
    ...
    static void Simplex(double[][] macierz, double[] ci, double[] cj, double[] bi, boolean min, int dl, int wys, boolean sl) {
        ...
        while(true){
            if (iteracje == 0) {
                for (int j = 0; j < dl; j++) {
                    for (int i = 0; i < wys; i++) {
                        if (ci[i] != -1999) { //tu wymyslic cos lepszego
