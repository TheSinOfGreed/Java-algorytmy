...
public class Main {
    public static void main(String[] args) {
        ...
        double srednia = 0;
        int uruchomienia = 10;
        for (int wyliczenie = 0; wyliczenie < uruchomienia; wyliczenie++) {

            Wymiar[] input_wymiary = {new Wymiar(-1, 1), new Wymiar(-1, 1)};
...
//        for(int index = 0; index < liczbaEPOK; index++){
//        System.out.println("**Epoka "+ (index+1) + "**");
...
//            if(index == liczbaEPOK -1){
//                    srednia += sukcesja.getSuma();
//            }
//        }
...
////    Z CZĘŚCIOWYM ZASTĘPOWANIEM
        ...
        System.out.println(srednia/uruchomienia);
    }
}