...
//                osobniki[i].setIndex(i+1);
        ...
        for(int i =0 ; i < paryOsobnikow.size() ; i++){
            //PUNKTY LOSOWANIE
            List<Integer> punkty = rng.ints(0, m).distinct().limit(2).boxed().collect(Collectors.toList());
...
//            System.out.println();
            ...
            zmienioneOsobnikiList.add(paryOsobnikow.get(i).rodzic1); // NEW
            zmienioneOsobnikiList.add(paryOsobnikow.get(i).rodzic2); // NEW
            //System.out.println();
        }
